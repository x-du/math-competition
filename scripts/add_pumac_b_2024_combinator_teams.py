#!/usr/bin/env python3
"""
One-off: Add team_id to PUMaC 2024 Combinatorics B results.

- Ensures every Combinatorics B team exists in database/students/teams.csv.
- Adds the corresponding team_id to each student's team_ids in database/students/students.csv.
- Adds a team_id column to database/contests/pumac-b-combinator/year=2024/results_B.csv.
"""
...
RESULTS_CSV = ROOT / "database" / "contests" / "pumac-b-combinator" / "year=2024" / "results_B.csv"


# Name -> team name for PUMaC 2024 Combinatorics B, from the official table.
NAME_TEAM_ROWS: list[tuple[str, str]] = [
    ...
    ("Rhys Llewellyn-Jones", "Pingry White Team"),
    ("Nathan Lee", "Individuals Team 161"),
    ("Maiya Qiu", "PHS Apricot"),
    ("Nikhil Byrapuram", "MathSchool 2"),
    ("Eric Dai", "Individuals Team 161"),
    ("Yuming Su", "Ward Melville Math Team"),
    ("Atticus Masuzawa", "Sierra Canyon School"),
    ("Harrison Chen", "MathSchool 2"),
    ("Andrew Xie", "Hotchkiss"),
    ("Ayan Dalmia", "Millburn Mathematical Madpeople"),
    ("Ryan Zhang", "Theta Math Club"),
    ("Tianze Qiu", "Theta Math Club"),
    ("Jason Liu", "Knights B"),
    ("Emmett Chen", "MathSchool 2"),
    ("Benjamin Sun", "Big L"),
    ("April Sun", "MathSchool 2"),
    ("Xinqi Jessie Wang", "PRISMS Young Falcons"),
    ("Ziyi Kaya Yang", "PRISMS Young Falcons"),
    ("Wenqing Eric Mao", "PRISMS Young Falcons"),
    ("Hridaan Mehta", "CRH Math Team"),
]
...
def load_results():
    """Load Combinatorics B results, returning list of rows."""
...
def main():
    ...
    # 5) Rewrite Combinatorics B results with team_id column.
    new_fieldnames = [
        "student_id",
        "team_id",
        "student_name",
    ...
    print("Updated teams.csv, students.csv, and Combinatorics B 2024 results_B.csv for PUMaC.")
