#!/usr/bin/env python3
"""
One-off: Add team_id to PUMaC 2025 Geometry B results.
...
- Adds a team_id column to database/contests/pumac-b-geometry/year=2025/results_B.csv.
"""
...
RESULTS_CSV = ROOT / "database" / "contests" / "pumac-b-geometry" / "year=2025" / "results_B.csv"


# Name -> team name for PUMaC 2025 Geometry B, from the official table.
NAME_TEAM_ROWS: list[tuple[str, str]] = [
    ("Liran Zhou", "Jericho A"),
    ("Kevin Feng", "EightTimesEpsilon"),
    ("Eden He", "Not Great Valley"),
    ("Atticus Masuzawa", "Sierra Canyon School"),
    ("Alexander Wang", "BCA 2"),
    ("Jay Wang", "PHS Avocado"),
    ("Hanru Zhang", "Jericho A"),
    ("Fiona Chen", "Big L Club"),
    ("Kevin Chen", "Ridge Mu Alpha Theta"),
    ("Yeojun Jung", "Individuals Team 190"),
    ("Joshua Shi", "THE Labubu"),
    ("Ryan Gong", "Individuals Team 191"),
    ("William Liu", "PHS Avocado"),
    ("Xinqi Jessie Wang", "PRISMS Young Falcons"),
    ("Kalina Liu", "Lexington Gamma"),
    ("Sidarth Singh", "Tigers"),
    ("Sophie Liu", "CRH"),
    ("Arda Eroz", "EightTimesEpsilon"),
    ("Andy Wu", "Stoga"),
    ("Alexander Choi", "BCA 2"),
    ("Olivia Fang", "Jericho B"),
    ("Srinivasa Polisetty", "Jericho B"),
    ("Alethea Liu", "Millburn Mathematical Madpeople"),
    ("Alexander Buteau", "Hotchkiss"),
    ("Oscar Huang", "PHS Avocado"),
    ("Iris Gao", "Pirates B"),
    ("Eric Yuan", "Individuals Team 189"),
    ("Chris Ping Liu", "Individuals Team 189"),
    ("Dhagesh Desai", "Millburn Mathematical Madpeople 2"),
    ("Angelina Gao", "Pingry"),
    ("Albert Wu", "Pingry"),
    ("Arav Sonawane", "OSS ORCAS"),
    ("Sean Gao", "Gunn Math"),
    ("Maggie Li", "Jericho A"),
    ("Sky Chen", "Jericho A"),
    ("Hridaan Mehta", "CRH"),
    ...
    ("Eric Chen", "Individuals Team 189"),
    ("Daniel Wu", "Not Great Valley"),
    ("Victor Wang", "Stoga"),
    ("Miles Zhang", "THE Labubu"),
    ("Shreyan Dutt", "Greater Boston"),
    ("Sophie Chen", "Hotchkiss"),
    ("Oma Makhija", "MH Math Knightmares"),
    ("Nikhil McGowan", "Sierra Canyon School"),
    ("Ray Cui", "Lexington Gamma"),
    ("Ekantika Chaudhuri", "Not Great Valley"),
    ("Bowen Li", "Jericho B"),
    ("Rithik Gumpu", "Arcadia High School A"),
]
...
def main():
    ...
    print("Updated teams.csv, students.csv, and Geometry B results_B.csv for PUMaC 2025.")
