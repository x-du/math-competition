#!/usr/bin/env python3
"""
One-off: Add team_id to PUMaC 2024 Algebra B results.

- Ensures every Algebra B team exists in database/students/teams.csv.
- Adds the corresponding team_id to each student's team_ids in database/students/students.csv.
- Adds a team_id column to database/contests/pumac-b-algebra/year=2024/results_B.csv.
"""
...
RESULTS_CSV = ROOT / "database" / "contests" / "pumac-b-algebra" / "year=2024" / "results_B.csv"


# Name -> team name for PUMaC 2024 Algebra B, from the official table.
NAME_TEAM_ROWS: list[tuple[str, str]] = [
    ...
    ("Shining Sun", "Individuals Team 162"),
    ("Michael Retakh", "Ward Melville Math Team"),
    ("Jason Lu", "MHSProfessionalJobbers"),
    ("Felix Liu", "Millburn Mathematical Madpeople"),
    ("Amy Lin", "PHS Apricot"),
    ("Joel Pulikkan", "MHSProfessionalJobbers"),
    ("Brian Sun", "Individuals Team 161"),
    ("Hanyu Ivey Wang", "PRISMS Young Falcons"),
    ("Bowen Li", "Jericho B"),
    ("Hyunjae Cho", "Individuals Team 169"),
    ("Sean Guo", "Arcadia High School"),
    ("Kellen Xue", "Arcadia High School"),
    ("Franklin Lee", "Theta Math Club"),
    ("Tianze Qiu", "Theta Math Club"),
    ("Ethan Li", "Theta Math Club"),
    ("Yeojin Jean Jung", "Individuals Team 162"),
    ("Jason Lian", "Individuals Team 161"),
    ("Cameron Rampell", "Individuals Team 161"),
    ("Charles Wang", "Individuals Team 161"),
    ("Aashritha Kolli", "Pingry White Team"),
    ("Kaiqi Xu", "Individuals Team 160"),
    ("Jack Wang", "Knights B"),
    ("Eric Chen", "Pingry Blue"),
    ("Diyansha Singh", "Pirates B"),
    ("Madeline Zhu", "Pingry Blue"),
    ("Suvid Bordia", "Pingry Blue"),
    ("Alice Kim", "MathSchool 2"),
    ("Bogdan Kremeznoy", "MathSchool 2"),
    ("Christian ZhouZheng", "Pingry Blue"),
    ("Alexander Mitev", "MathSchool 2"),
    ("Emmett Chen", "MathSchool 2"),
    ("Tina Zhao", "Hotchkiss"),
    ("Amelie Huang", "PHS Blueberry"),
    ("Eric Zou", "Ward Melville Math Team"),
    ("Karson Jiang", "Millburn Mathematical Madpeople"),
    ("Alexander Sheng", "PHS Blueberry"),
    ("Alethea Liu", "Millburn Mathematical Madpeople"),
    ("Vyom Siriyapu", "Not Great Valley"),
    ("Manas Goyal", "Not Great Valley"),
    ("Ziyi Kaya Yang", "PRISMS Young Falcons"),
    ("Yuming Su", "Ward Melville Math Team"),
    ("Akshay Gupta", "Big L"),
    ("Advait Joshi", "Big L"),
    ("Erika Kawakami", "Jericho B"),
    ("Atiksh Akunuri", "Big L"),
    ("Emma Li", "PHS Apricot"),
    ("Benjamin Zhao", "PRISMS Baby Falcons"),
    ("Jacqueline Lu", "MHSProfessionalJobbers"),
    ("Dian Yang", "Jericho B"),
    ("Vincent Yang", "Jericho A"),
    ("Maggie Li", "Jericho A"),
    ("Allen Ma", "PRISMS Baby Falcons"),
]
...
def load_results():
    """Load Algebra B results, returning list of rows."""
...
def main():
    ...
    # 5) Rewrite Algebra B results with team_id column.
    new_fieldnames = [
        "student_id",
        "team_id",
        "student_name",
    ...
    print("Updated teams.csv, students.csv, and Algebra B 2024 results_B.csv for PUMaC.")
