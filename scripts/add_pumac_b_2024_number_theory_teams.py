#!/usr/bin/env python3
"""
One-off: Add team_id to PUMaC 2024 Number Theory B results.
...
- Adds a team_id column to database/contests/pumac-b-number-theory/year=2024/results_B.csv.
"""
...
RESULTS_CSV = ROOT / "database" / "contests" / "pumac-b-number-theory" / "year=2024" / "results_B.csv"


# Name -> team name for PUMaC 2024 Number Theory B, from the official table.
...
def main():
    ...
    print("Updated teams.csv, students.csv, and Number Theory B 2024 results_B.csv for PUMaC.")
