#!/usr/bin/env python3
"""
One-off: Add team_id to PUMaC 2025 Algebra B results.
...
- Adds a team_id column to database/contests/pumac-b-algebra/year=2025/results_B.csv.
"""
...
RESULTS_CSV = ROOT / "database" / "contests" / "pumac-b-algebra" / "year=2025" / "results_B.csv"


# Name -> team name for PUMaC 2025 Algebra B, from the official table.
NAME_TEAM_ROWS: list[tuple[str, str]] = [
    ("Eden He", "Not Great Valley"),
    ("Alexander Sheng", "PHS Avocado"),
    ("Kevin Chen", "Ridge Mu Alpha Theta"),
    ("Derrick Chen", "Individuals Team 189"),
    ("Max Li", "Gunn Math"),
    ("Angelica Feng", "PRISMS Young Falcons"),
    ("Zili Chang", "Millburn Mathematical Madpeople 2"),
    ("Alex Bae", "Gunn Math"),
    ("Brayden Choi", "OSS ORCAS"),
    ("Hridaan Mehta", "CRH"),
    ("Aryaveer Shishodia", "Big L Club"),
    ("Bret Huang", "Individuals Team 189"),
    ("Alexander Choi", "BCA 2"),
    ("Benjamin Sun", "Big L Club"),
    ("Grace Liang", "MHSProfessionalJobbers"),
    ("Jay Wang", "PHS Avocado"),
    ("Aadya Kolli", "Knights Y"),
    ("Karam Gill", "Greater Boston"),
    ("Yeojun Jung", "Individuals Team 190"),
    ("Jason Lu", "MHSProfessionalJobbers"),
    ("Likhith Malipati", "Pirates B"),
    ("Yejoon Na", "PHS Avocado"),
    ("Eric Zou", "Ward Melville Math Team"),
    ("Derek Peng", "Pingry"),
    ("Cameron Rampell", "Gunn Math"),
    ("Alan Zhang", "Jericho B"),
    ("Jingxuan Wang", "Millburn Mathematical Madpeople"),
    ("Madeline Zhu", "Pingry"),
    ("Suvid Bordia", "Pingry"),
    ("Atiksh Akunuri", "Big L Club"),
    ("Karson Jiang", "Millburn Mathematical Madpeople"),
    ("Sean Gao", "Gunn Math"),
    ("Charles Chen", "Lexington Gamma"),
...
def main():
    ...
    print("Updated teams.csv, students.csv, and Algebra B results_B.csv for PUMaC 2025.")
